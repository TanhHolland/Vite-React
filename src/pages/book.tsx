        ...
        <div className="flex items-start bg-[#F5F5FA] py-4 gap-5 justify-center">
            ...
            <div className="flex flex-col gap-5 w-1/3">
                <div className="bg-white rounded-lg p-3 flex flex-col gap-3">
                    <p>
                        Tác giả:{" "}
                        <span className="text-[rgb(13,_92,_182)]">
                            John C.Maxwell
                        </span>
                    </p>
                    <h3 className="text-[rgb(39,_39,_42)] text-xl font-medium">
                        Thay Đổi Tư Duy - 11 Phương Pháp Thay Đổi Thói Quen Để
                        Sống Đời Thành Công (John C. Maxwell)
                    </h3>
            ...
            <div className="bg-white rounded-lg p-3 flex flex-col gap-3 w-[360px]">
                ...
                <div className="flex items-center gap-2">
                    <button className="rounded cursor-pointer border-1 border-solid h-[32px] px-1">
                        <img
                    ...
                    />
                    <button className="rounded cursor-pointer border-1 border-solid p-1 h-[32px] px-1">
                        <img
                ...
                <span className="font-semibold text-2xl">76000₫</span>
