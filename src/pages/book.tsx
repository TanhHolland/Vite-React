  ...
  return (
    <div className="flex items-start bg-[#F5F5FA] py-4 gap-5 justify-center">
      ...
      <div className="bg-white rounded-lg p-3 flex flex-col gap-3 w-[360px]">
        ...
        <div className="flex items-center gap-2">
          <button className="rounded cursor-pointer border-1 border-solid h-[32px] px-1" onClick={handleDecrease}>
            <img
          ...
          <input
            ...
            value={count}
          />
          <button className="rounded cursor-pointer border-1 border-solid p-1 h-[32px] px-1" onClick={handleIncrease}>
            <img
        ...
        <span className="font-semibold text-2xl">{product?.price ? product.price * count + " ₫" : "0 ₫"}</span>
